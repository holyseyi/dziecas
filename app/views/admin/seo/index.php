...
<form method="POST" action="<?= url('/admin/seo') ?>" class="bg-white dark:bg-gray-800 rounded-xl p-6 space-y-4">
    <?= csrf_field() ?>
    ...
    <?php endforeach; ?>
    <button type="submit" class="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2 rounded-lg transition">Save SEO</button>
</form>
